class ApplicationController < ActionController::Base
  ...
  before_action :authenticate_user!, except: [:after_sign_in_path_for, :about_us, :contact_us, :visitors, :list_products, :index, :search, :show, :term_condition, :contact_detail]
