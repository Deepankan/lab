...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { description: @advertisement.description, end_date: @advertisement.end_date, images: @advertisement.images, start_date: @advertisement.start_date, title: @advertisement.title, web_url: @advertisement.web_url }
    end
  ...
  test "should update advertisement" do
    patch :update, id: @advertisement, advertisement: { description: @advertisement.description, end_date: @advertisement.end_date, images: @advertisement.images, start_date: @advertisement.start_date, title: @advertisement.title, web_url: @advertisement.web_url }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
